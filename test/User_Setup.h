...
#define TFT_DC   18  // A0/DC   Data Command control pin
#define TFT_CS   10  // CS      Chip select control pin
#define TFT_MOSI 11  // SDA
#define TFT_SCLK 12  // SCK/SCL
 // LED/BLK LED back-light (required for M5Stack)
#define TFT_RST  40  // RST     Reset pin (could connect to RST pin) - 
